...
import { createBouncingBallDemo } from "./bouncingBallDemo.ts";
...
initDemoNav("bouncing-ball.html");
initDemoInfo("Bouncing Ball Demo (WebGPU)", [
  "Physics simulation",
  "Rubber material bouncing",
  "Colorful dynamic spheres",
  "Static ground plane",
...
const demo = createBouncingBallDemo(assets);
...
logger.info("🎾 Bouncing Ball Demo started!");
